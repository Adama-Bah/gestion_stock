								...
								<div class="dropdown text-center selector">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
										<div class="text-center">
											<a href="#" class="dropdown-item text-center font-weight-sembold user" data-toggle="dropdown">Adama Djan Bah</a>
										...
										<a class="dropdown-item" href="deconnection.php">
											<i class="dropdown-icon mdi  mdi-logout-variant"></i> Se Deconnecter
										</a>
									</div>
								</div>
							</div>
